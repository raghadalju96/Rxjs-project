...
var newValues5 = observable2.pipe((0, _rxjs.reduce)(function (acc, val) {
  return acc + val;
}, 0) // 15
);
var newValues6 = observable2.pipe((0, _rxjs.take)(3), (0, _rxjs.tap)(console.log), (0, _rxjs.reduce)(function (acc, val) {
  return acc + val;
}, 0) //6
);
var newValues7 = observable2.pipe((0, _rxjs.take)(3), (0, _rxjs.scan)(function (acc, val) {
  return acc + val;
}, 0) // 1 3 6
);
var subscribtion = newValues6.subscribe({
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pipe-operators.js"], null)
//# sourceMappingURL=/pipe-operators.b4b0fc4e.js.map