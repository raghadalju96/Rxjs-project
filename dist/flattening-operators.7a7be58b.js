...
},{"../internal/ajax/ajax":"../node_modules/rxjs/dist/esm5/internal/ajax/ajax.js","../internal/ajax/errors":"../node_modules/rxjs/dist/esm5/internal/ajax/errors.js","../internal/ajax/AjaxResponse":"../node_modules/rxjs/dist/esm5/internal/ajax/AjaxResponse.js"}],"flattening-operators.js":[function(require,module,exports) {
"use strict";
...
var button = document.querySelector("#btn"); // const opservable = fromEvent(button, "click").pipe(
//   mergeMap(() => {
//     return ajax.getJSON("https://jsonplaceholder.typicode.com/todos/1");
//   })
// );

var opservable1 = (0, _rxjs.fromEvent)(button, "click").pipe((0, _rxjs.mergeMap)(function () {
  return (0, _rxjs.interval)(1000).pipe((0, _rxjs.take)(5), (0, _rxjs.tap)(console.log)); // The outer observable never completes, but the inner observable does
}));
var opservable2 = (0, _rxjs.fromEvent)(button, "click").pipe((0, _rxjs.exhaustMap)(function () {
  return (0, _rxjs.interval)(1000).pipe((0, _rxjs.take)(5), (0, _rxjs.tap)({
    complete: function complete() {
      return console.log("inner opservable completed");
    }
  }));
}));
var subscribtion = opservable2.subscribe({
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","flattening-operators.js"], null)
//# sourceMappingURL=/flattening-operators.7a7be58b.js.map